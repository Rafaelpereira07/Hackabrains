import { Brain, Users, FileText, ListChecks, ArrowRight, Sparkles, Menu, X } from "lucide-react"
...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Inteligência artificial que auxilia na tomada de decisão com base no histórico clínico.",
    },
    {
      icon: FileText,
    ...
    },
    {
      ...
      description: "Próximos passos definidos automaticamente para otimizar o tratamento do paciente.",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm text-gray-600 hover:text-emerald-600 transition">
              Recursos
            </a>
            <a href="#how" className="text-sm text-gray-600 hover:text-emerald-600 transition">
              Como funciona
            </a>
            <a href="#about" className="text-sm text-gray-600 hover:text-emerald-600 transition">
              Sobre
            </a>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 p-4 space-y-3">
            <a href="#features" className="block text-sm text-gray-600 hover:text-emerald-600 py-2">
              Recursos
            </a>
            <a href="#how" className="block text-sm text-gray-600 hover:text-emerald-600 py-2">
              Como funciona
            </a>
            <button
              onClick={() => navigate("/login")}
       ...
       from-emerald-50 via-white to-teal-50">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-emerald-100 px-3 py-1.5 rounded-full mb-6">
            ...
            <span className="text-xs font-semibold text-emerald-700">Potenciado por Inteligência Artificial</span>
          </div>
          ...
          <p className="text-lg text-emerald-600 font-medium mb-4">Automação e IA na Jornada do Paciente</p>
          <p className="text-base text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
            Centralize o histórico completo dos pacientes e deixe a IA gerar relatórios clínicos estruturados com plano
            de ação automatizado para auxiliar na tomada de decisão.
          </p>
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-semibold text-gray-900 text-center mb-12">Recursos Principais</h2>
      ...
      <section id="how" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-semibold text-gray-900 text-center mb-12">Como Funciona</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-emerald-600 text-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-semibold text-center mb-12">Confiado por Profissionais</h2>
      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-semibold text-gray-900 mb-6 text-center">Sobre ClinIA</h2>
          <p className="text-base text-gray-600 leading-relaxed mb-4">
            ClinIA é uma plataforma inovadora desenvolvida para transformar a gestão de saúde através da
            inteligência artificial. Nosso aplicativo centraliza todo o histórico de saúde e consultas anteriores em
            um banco de dados unificado, garantindo que o médico tenha o contexto completo em segundos.
          </p>
          <p className="text-base text-gray-600 leading-relaxed">
            A IA integrada atua como assistente de decisão clínica — ela gera automaticamente um relatório estruturado
            que auxilia o médico a definir o melhor tratamento e entrega um plano de ação claro com os próximos passos
            para o paciente.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-emerald-600 text-white">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-base text-emerald-100 mb-8">
            Explore o dashboard completo com dados de exemplo e IA real integrada.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={() => navigate("/dashboard")}
